...
VALUES
    ...
    (2, 'Lunar Gateway', 1, '2024-01-01', 0, 0),
    (3, 'Mars Base Alpha', 2, '2030-05-15', 0, 0),
    (4, 'Europa Outpost', 3, '2040-09-10', 0, 0);
...
VALUES
    (1, 'Dragon', false, 1, '2010-12-08', 1, 28000, 7),
    (2, 'Starliner', false, 1, '2021-01-01', 2, 28500, 7),
    (3, 'Soyuz', false, 1, '1967-11-28', 3, 28000, 3),
    (4, 'Ariane 5', false, 1, '1996-06-04', 4, 10800, 10);
...
VALUES
    (1, 1, 1, 1, 2, 'IN_PROGRESS', '2022-01-01 08:00:00', NULL),
    (2, 2, 2, 1, 3, 'IN_PROGRESS', '2022-02-01 10:00:00', NULL),
    (3, 3, 3, 1, 4, 'IN_PROGRESS', '2022-03-01 12:00:00', NULL),
    (4, 4, 4, 1, 2, 'IN_PROGRESS', '2022-04-01 14:00:00', NULL);
